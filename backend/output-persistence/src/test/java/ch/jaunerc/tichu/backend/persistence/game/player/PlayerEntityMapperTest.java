...
class PlayerEntityMapperTest {
    ...
    void toDomain() {
        ...
        var playerEntity = new PlayerEntity(uuid, user, FIRST, TichuCall.NOT_ANSWERED,TichuCalled.NOT_CALLED, TichuCalled.NOT_CALLED, false, cards, pushedCards, receivedCards);
