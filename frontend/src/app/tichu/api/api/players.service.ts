...
export class PlayersService implements PlayersServiceInterface {
   ...
   */
  public createPlayer(playerName: string, observe?: 'body', reportProgress?: boolean, options?: {
    httpHeaderAccept?: 'application/json',
    context?: HttpContext
  }): Observable<Player>;
  public createPlayer(playerName: string, observe?: 'response', reportProgress?: boolean, options?: {
    httpHeaderAccept?: 'application/json',
    context?: HttpContext
  }): Observable<HttpResponse<Player>>;
  public createPlayer(playerName: string, observe?: 'events', reportProgress?: boolean, options?: {
    httpHeaderAccept?: 'application/json',
    context?: HttpContext
  }): Observable<HttpEvent<Player>>;
  public createPlayer(playerName: string, observe: any = 'body', reportProgress: boolean = false, options?: {
    httpHeaderAccept?: 'application/json',
    context?: HttpContext
  }): Observable<any> {
    ...
    let localVarPath = `/players/${this.configuration.encodeParam({
      name: "playerName",
      value: playerName,
      in: "path",
      style: "simple",
